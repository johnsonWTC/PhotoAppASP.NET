...
namespace PhotoApp.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("commentID,commentContent,commentLikes,commentViews,postID,ApplicationUserId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("commentID,commentContent,commentLikes,commentViews,postID,ApplicationUserId")] Comment comment)
        {
